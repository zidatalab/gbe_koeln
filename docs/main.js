...
let ApiService = class ApiService {
    constructor(httpClient) {
        ...
        this.REST_API_SERVER = "https://zidashboardapi.azurewebsites.net/"; //"http://localhost:8000/" ;// "https://zidashboardapi.azurewebsites.net/";  "http://localhost:8000/" //
